...
$user_email = mysqli_real_escape_string($mysqli, htmlspecialchars(trim($_POST['user_email'])));

$query = mysqli_query($mysqli, "SELECT * FROM `Login4` WHERE user_email = '$user_email'");
